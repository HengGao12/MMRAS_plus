...
class MaskFormerSemanticDatasetMapper:
    ...
    def __init__(
        ...
        *,
        ...
        self.anomaly_file_path = anomaly_file_path  # [anomaly_file_path]
    ...
    def __call__(self, dataset_dict):
        ...
        if self.is_ood_ft: 
            if np.random.uniform() < self.anomaly_mix_ratio:
                ...
                coco_img_path = coco_gt_path.replace('annotations/ood_seg_train2017', 'train2017')
                # coco_img_path = coco_gt_path.replace()
                ...
                image, sem_seg_gt = mix_object(current_labeled_image=image.copy(), current_labeled_mask=sem_seg_gt.copy(), cut_object_image=coco_img.copy(), cut_object_mask=coco_gt.copy())
